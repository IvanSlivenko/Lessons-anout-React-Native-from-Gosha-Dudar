...
export default function App() {
  ...
  const handleImagePress = () => {
    ...
    Alert.alert("UmanProger", "Main message  from image", [
      { text: "Так", onPress: () => console.log('Yes button from image') },
      { text: "Відмінити", onPress: () => console.log('No button from image') }
    ]);
  };
